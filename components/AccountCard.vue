  ...
  div.flex.justify-between
    ...
    div.flex-0(v-if="earnedLimit!==null")
      div.flex.tracking-wide.text-xs
        p.flex-1 Limit
        div.text-xs.ps-6(v-if="earnedCycle.length > 0" v-popover:tooltip="`You are eligible for a limit of Rs: ${this.cashFundCycle[0].credit_value} per day between ${this.cashFundCycle[0].credit_start_day} and ${this.cashFundCycle[0].credit_end_day} of the month`")
